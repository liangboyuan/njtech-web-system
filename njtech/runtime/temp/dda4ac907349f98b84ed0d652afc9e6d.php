<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/Applications/MAMP/htdocs/njtech/application/admin/view/article2/lst.html";i:1547045941;s:73:"/Applications/MAMP/htdocs/njtech/application/admin/view/public/title.html";i:1539919235;s:71:"/Applications/MAMP/htdocs/njtech/application/admin/view/public/top.html";i:1532587766;s:72:"/Applications/MAMP/htdocs/njtech/application/admin/view/public/left.html";i:1545290838;}*/ ?>
<!DOCTYPE html>
<html><head>
	    <meta charset="utf-8">
                        ...
                        <table class="table table-bordered table-hover">
                            <thead class="">
                                <tr>
                                    ...
                                    <th class="text-center" width="10%">所属科室</th>
                                    <th class="text-center" width="10%">时间</th>
                                    <th class="text-center" width="20%">操作</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if(is_array($artres2) || $artres2 instanceof \think\Collection): $i = 0; $__LIST__ = $artres2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$art): $mod = ($i % 2 );++$i;?>
                                <tr>
                                    ...
                                    <td align="center">
                                        <?php switch($art['k_id']): case "1": ?>综合事务部<?php break; case "2": ?>专业建设科<?php break; case "3": ?>教学运行科<?php break; case "4": ?>实践教学科<?php break; case "5": ?>学业事务科<?php break; case "6": ?>学生交流科<?php break; case "7": ?>教学评价科<?php break; case "8": ?>现代教育中心<?php break; case "9": ?>教师（教学）发展中心<?php break; endswitch; ?>
                                    </td>
                                    <td align="center"><?php echo date("Y-m-d",$art['time']); ?></td>
                                    <td align="center">
