                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            ...
                            <div class="panel-body" style="min-height: 500px;">
                                <table class="table">
                                    <?php if(is_array($article) || $article instanceof \think\Collection): $i = 0; $__LIST__ = $article;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$article1): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td><a href="<?php echo url(('article2/index'),array('cateid'=>$article1['id'])); ?>"><?php echo $article1['title']; ?></a></td>
                                        <td width="100px"><a href="<?php echo url(('article2/index'),array('cateid'=>$article1['id'])); ?>"><?php echo date("Y-m-d",$article1['time']); ?></a></td>
                                    </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </table>
                            </div>
