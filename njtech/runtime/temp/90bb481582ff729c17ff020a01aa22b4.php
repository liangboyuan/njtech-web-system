            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <form action="" method="post">
                            ...
                            <tbody>
                                <?php if(is_array($linkres) || $linkres instanceof \think\Collection): $i = 0; $__LIST__ = $linkres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$link): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php switch($link['cate']): case "1": ?>校内链接<?php break; case "2": ?>校外链接<?php break; endswitch; ?>
                                        </td>
                                        <td align="center">
                        ...
                        <div><input class="btn btn-primary btn-sm shiny" style="margin-left:20px; margin-top:10px;" type="submit" value="排序" ></div>
                    </form>
                </div>
