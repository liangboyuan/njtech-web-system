                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" >
                        ...
                        <!--<div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cateid">
                                    <option <?php if($arts['cateid'] == 1): ?>selected="selected"<?php endif; ?> value="1">教学公告</option>
                                    <option <?php if($arts['cateid'] == 2): ?>selected="selected"<?php endif; ?> value="2">教学新闻</option>
                                    <option <?php if($arts['cateid'] == 3): ?>selected="selected"<?php endif; ?> value="3">学科竞赛</option>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>-->
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="k_id">
                                    ...
                                    <option <?php if($arts['k_id'] == 8): ?>selected="selected"<?php endif; ?> value="8">现代教育中心</option>
                                    <option <?php if($arts['k_id'] == 9): ?>selected="selected"<?php endif; ?> value="9">教师（教学）发展中心</option>
                                </select>
                            </div>
