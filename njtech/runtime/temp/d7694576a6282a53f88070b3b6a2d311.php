...
<nav class="navbar" role="navigation" style="background-color: #265CB4">
    ...
    <div class="container body-content mycontent">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <form class="form-inline" action="<?php echo url('search/index'); ?>" method="get" role="form">
                    <div class="form-group" style="">
                        <input type="text" class="form-control" name="keywords" id="keywords" placeholder="请输入关键词" style="width: 81%;float: left;">
        ...
        <!--<div class="row" style="margin-top: 10px;">
            <div class="col-md-12">
                <div class="container-fluid">
                    <h4><span class="glyphicon glyphicon-list-alt" aria-hidden="true" style="float: left;margin-right: 10px"></span>信息搜索</h4>
                </div>
                    ...
                    <div class="col-md-12">
                        <div class="panel" style="min-height: 500px">
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    <?php if($keywords != ''): if(is_array($serRes) || $serRes instanceof \think\Collection): $i = 0; $__LIST__ = $serRes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td><a href="<?php echo url('Article/search',array('artid'=>$res['id'])); ?>"><?php echo $res['title']; ?></a></td>
                                        <td width="100px"><a href="<?php echo url('Article/search',array('artid'=>$res['id'])); ?>"><?php echo date("Y-m-d",$res['time']); ?></a></td>
                                    </tr>
...
<!--底部导航栏-->
<div class="myfooter hidden-print" style="width:100%;min-height:50px;color:white;height: 100px;background-color: #265CB4;overflow: hidden">
    <!--<div style="float: right;position: absolute;">
        <img src="__INDEX__/images/njtech2.png" alt="" style="width: 70px;height: 80px;float: right;" class="img-rounded">
    </div>-->
    <div class="container" style="max-width: 1150px;margin: 0 auto;height: 100px;">
        <div class="col-md-4" style="height: 100px;float: left;">
        ...
        <div class="col-md-4" style="height: 100px;width: 510px;float: right;">
            <div style="height: 80px;width: 80px;margin:10px 20px;float: left">
