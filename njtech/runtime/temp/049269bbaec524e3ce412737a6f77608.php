        ...
        <div class="row" style="margin-top: 10px">
            ...
            <div class="col-md-12">
                <div class="row">
                    ...
                    <div class="col-md-6"style="min-height:320px;margin-top: 3px;margin-bottom: 3px;">
                        <div class="panel" style="min-height: 280px;">
                            ...
                            <div class="panel-body">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><a href="<?php echo url(('article/index'),array('cateid'=>$v2['id'])); ?>"><span><?php echo $v2['title'];?></span></a></td>
