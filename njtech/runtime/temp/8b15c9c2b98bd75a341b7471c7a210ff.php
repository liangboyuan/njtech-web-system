...
<button type="button" tooltip="添加配置" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('conf'); ?>'"> <i class="fa fa-plus"></i> Add
</button>
<div class="row">
                ...
                <div class="flip-scroll">
                    <form action="" method="post">
                        <table class="table table-bordered table-hover">
                            <thead class="">
                                <tr>
                                    <th class="text-center" width="">专题名称</th>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <td align="center"><?php echo $conf['them_name']; ?></td>
