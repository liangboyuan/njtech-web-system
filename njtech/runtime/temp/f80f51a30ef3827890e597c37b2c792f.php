<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:73:"/Applications/MAMP/htdocs/njtech/application/index/view/article/file.html";i:1546529210;s:73:"/Applications/MAMP/htdocs/njtech/application/index/view/public/title.html";i:1546530291;s:71:"/Applications/MAMP/htdocs/njtech/application/index/view/public/top.html";i:1546932553;s:72:"/Applications/MAMP/htdocs/njtech/application/index/view/public/foot.html";i:1545457848;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                ...
                <ul class="nav navbar-nav nav-pills" style="display: inline-block;float: none;">
                    ...
                    <li class="dropdown" style="background-color: #265CB4;color: white;width: 100px;">
                        <a style="background-color: #265CB4;color: white;" id="dLabel" role="button" data-toggle="dropdown" class="btn" data-target="<?php echo url('listmenu/lst'); ?>"
                           href="/index/artlist/lst/cateid/<?php echo $cate['id']; ?>">
                        ...
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu" style="width: 100px;">
                            ...
                            <li style="width: 100px;height: 35px;">
                                <a href="/index/artlist/lst/cateid/<?php echo $v2['id']; ?>"><?php echo $v2['catename'];?></a>
            ...
            <div class="col-md-9">
                <div class="panel" style="margin-top: 10px;border: 1px solid #265CB4;">
                    ...
                    <div class="panel-body" style="min-height: 500px">
                        ...
                        <div>
                            <p align="center" style="color: grey;">浏览次数：<?php echo $data['click']; ?> &nbsp&nbsp <?php echo date("Y-m-d",$data['time']); ?> &nbsp &nbsp<?php echo $data['author']; ?> </p>
                        </div>
