...
<nav class="navbar" role="navigation" style="background-color: #265CB4">
    ...
    <div class="container-fluid"  style="max-width: 1250px;min-height: 450px">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="panel" style="margin-top: 10px;border: 1px solid #265CB4;">
                    ...
                    <div class="panel-body" style="min-height: 500px;">
                        <div style="margin-top: -20px;">
                            <h3 align="center"><?php echo $data['title']; ?></h3>
                        </div>
                        <div>
                            <p align="center" style="color: grey;"><?php echo date("Y-m-d H:m",$data['time']); ?>&nbsp&nbsp<?php echo $data['author']; ?> </p>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="list-group" style="margin-top: 10px">
                            ...
                            <li class="list-group-item" style="border-bottom:dashed 1px #ccc;border-top:dashed 1px #ccc;height:60px;">
                                <div style="width:100%;height:38px; overflow:hidden;"><a href="<?php echo url('article2/index',array('cateid'=>$newlist['id'])); ?>" title="" style="">[<?php echo date("y-m-d",$newlist['time']); ?>]<?php echo $newlist['title']; ?></a></div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
