                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" >
                       <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">校历第一周周一为：</label>
                            <div class="col-sm-6">
                                <div style="width: 50px; float: left">
                                    <input style="width: 50px;height: 30px;" type="text" name="year"/>
                                </div>
                                <div style="margin-left:10px;margin-top:3px;float: left">
                                    <p>年</p>
                                </div>
                                <div style="width: 50px; float: left;margin-left: 10px;">
                                    <input style="width: 50px;height: 30px;" type="text" name="month"/>
                                </div>
                                <div style="margin-left:10px;margin-top:3px;float: left">
                                    <p>月</p>
                                </div>
                                <div style="width: 50px; float: left;margin-left: 10px;">
                                    <input style="width: 50px;height: 30px;" type="text" name="day"/>
                                </div>
                                <div style="margin-left:10px;margin-top:3px;float: left">
                                    <p>日</p>
                                </div>
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">上传PDF校历文件：</label>
                            <div class="col-sm-6">
