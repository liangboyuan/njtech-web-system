            ...
            <div class="col-md-9">
                <div class="panel" style="margin-top: 10px;border: 1px solid #265CB4;">
                    ...
                    <div class="panel-body" style="min-height: 500px">
                        ...
                        <div>
                            <p align="center" style="color: grey;">浏览次数：<?php echo $data['click']; ?> &nbsp&nbsp <?php echo date("Y-m-d H:m",$data['time']); ?>&nbsp&nbsp<?php echo $data['author']; ?> </p>
                        </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="list-group" style="margin-top: 10px">
                            ...
                            <li class="list-group-item" style="border-bottom:dashed 1px #ccc;border-top:dashed 1px #ccc;height:60px;">
                                <div style="width:100%;height:38px; overflow:hidden;"><a href="<?php echo url('article/file',array('cateid'=>$newlist['id'])); ?>" title="" style="">[<?php echo date("y-m-d",$newlist['time']); ?>]<?php echo $newlist['title']; ?></a></div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
