                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('lst'); ?>">专题栏目</a>
                    </li>
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data" >
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">专题栏目</label>
                            <div class="col-sm-6">
                                <select name="k_id">
                                    ...
                                    <option value="<?php echo $them['id']; ?>"><?php echo $them['them_name']; ?></option>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </div>
