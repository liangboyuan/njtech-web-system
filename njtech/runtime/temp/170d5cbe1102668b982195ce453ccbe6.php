            ...
            <div class="col-md-9">
                <div class="panel" style="margin-top: 10px;min-height: 500px; border: 1px solid #265CB4;">
                    ...
                    <div class="panel-body">
                        ...
                        <div>
                            <p align="center" style="color: grey;">浏览次数：<?php echo $articles['click']; ?> &nbsp&nbsp <?php echo date("Y-m-d H:m",$articles['time']); ?>&nbsp&nbsp<?php echo $articles['author']; ?> </p>
                        </div>
