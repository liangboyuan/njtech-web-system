<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:88:"/Applications/MAMP/htdocs/njtech/public/../application/index/view/listmenu/listmenu.html";i:1535009188;s:81:"/Applications/MAMP/htdocs/njtech/public/../application/index/view/public/top.html";i:1535033606;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
        ...
        <div style="margin:0 auto;">
            ...
            <div class="collapse navbar-collapse" id="example-navbar-collapse" style="text-align: center;">
                <ul class="nav navbar-nav nav-pills" style="display: inline-block;float: none;">
                    ...
                    <?php if(is_array($cateres) || $cateres instanceof \think\Collection): $i = 0; $__LIST__ = $cateres;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cate): $mod = ($i % 2 );++$i;?>
                    <li class="dropdown" style="background-color: #0093dd;color: white;">
                        <a style="background-color: #0093dd;color: white;" id="dLabel" role="button" data-toggle="dropdown" class="btn" data-target="#"
                           href="<?php echo url('listmenu/listmenu'); ?>">
