<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:77:"/Applications/MAMP/htdocs/njtech/application/index/view/article/article2.html";i:1546529210;s:73:"/Applications/MAMP/htdocs/njtech/application/index/view/public/title.html";i:1546530291;s:71:"/Applications/MAMP/htdocs/njtech/application/index/view/public/top.html";i:1547438237;s:72:"/Applications/MAMP/htdocs/njtech/application/index/view/public/foot.html";i:1547054214;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                ...
                <div class="panel" style="margin-top: 10px;min-height: 500px; border: 1px solid #265CB4;">
                    ...
                    <div class="panel-body">
                        <div style="margin-top: -20px;">
                            <h3 align="center"><?php echo $articles['title']; ?></h3>
                        </div>
                        <div>
                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="list-group" style="margin-top: 10px">
                            ...
                            <li class="list-group-item" style="border-bottom:dashed 1px #ccc;border-top:dashed 1px #ccc;height:60px;">
                                <div style="width:100%;height:38px; overflow:hidden;"><a href="<?php echo url('article/index',array('cateid'=>$newlist['id'])); ?>" title="" style="">[<?php echo date("y-m-d",$newlist['time']); ?>]<?php echo $newlist['title']; ?></a></div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
