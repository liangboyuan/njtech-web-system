            ...
            <div class="col-md-9">
                <ol class="breadcrumb">
                    ...
                    <li>
                        ...
                        <a href='<?php echo url('artlist/lstpage',array('cateid'=>$posCate['id'])); ?>'><?php echo $posCate['catename']; ?></a> >
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </li>
                </ol>
            </div>
                    ...
                    <div class="col-md-12"style="margin-top: 3px;margin-bottom: 3px;">
                        <div class="panel" style="">
                            <div class="panel-heading" style="background-color: #265CB4;color: white;">
                                <h3 class="panel-title"><?php echo $catename['catename']; ?></h3>
                            </div>
                            <div class="panel-body" style="min-height: 500px;">
                                <table class="table">
                                    <?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td><a href="<?php echo url(('article/index'),array('cateid'=>$data['id'])); ?>"><span><?php echo $data['title']; ?></span></a></td>
                                        <td width="100px"><a href="<?php echo url(('article/index'),array('cateid'=>$data['id'])); ?>"><?php echo date("Y-m-d",$data['time']); ?></a></td>
                                    </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </table>
                            </div>
