...
<nav class="navbar" role="navigation" style="background-color: #265CB4">
    ...
    <!--主体部分开始-->
    <div class="container body-content mycontent" style="min-height: 500px;">
        <!--面包屑导航和搜索框开始-->
        <div class="row">
            <div class="col-md-9">
                <ol class="breadcrumb">
                    <li><a href="<?php echo url('index/index'); ?>">网站首页</a></li>
                    <li class="active">专题栏目</li>
                </ol>
            </div>
            <div class="col-md-3">
        ...
        <!--<div class="row" style="margin-top: 10px;">
            <div class="col-md-12">
                <div class="container-fluid">
                    <h4><span class="glyphicon glyphicon-list-alt" aria-hidden="true" style="float: left;margin-right: 10px"></span>专题栏目设置</h4>
                </div>
            ...
            <div class="container-fluid" style="">
                ...
                <div class="col-md-3 them1" style="border: 2px solid WhiteSmoke;border-radius: 10px;background-color:white;margin-top: 10px;">
                    ...
                    <div style="width: 100%;height: 70px;">
                        ...
                        <div style="width: 100%;height: 21px;overflow: hidden">
