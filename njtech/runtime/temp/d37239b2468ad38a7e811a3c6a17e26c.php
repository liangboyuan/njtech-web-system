                    ...
                    <div class="col-md-12">
                        <div class="panel">
                            <div class="panel-heading" style="background-color: #265CB4;color: white;">
                                <h3 class="panel-title"><?php echo $them_name; ?></h3>
                            </div>
                            <div class="panel-body" style="min-height: 500px;">
                                <table class="table">
                                    <?php if(is_array($data) || $data instanceof \think\Collection): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data1): $mod = ($i % 2 );++$i;?>
                                    <tr>
                                        <td><a href="<?php echo url(('article/them'),array('cateid'=>$data1['id'])); ?>"><?php echo $data1['title']; ?></a></td>
                                        <td width="100px"><a href="<?php echo url(('article/them'),array('cateid'=>$data1['id'])); ?>"><?php echo date("Y-m-d",$data1['time']); ?></a></td>
                                    </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </table>
                            </div>
