        ...
        <div class="row">
            <div class="col-md-9">
                <ol class="breadcrumb">
                    ...
                    <li class="active"><a href="<?php echo url('them/index'); ?>">专题栏目</a></li>
                    <li class="active"><?php echo $them_name; ?></li>
                </ol>
            </div>
            <div class="col-md-3">
                    ...
                    <div class="col-md-12">
                        ...
                        <ul class="list-group" style="margin-top: 10px">
                            ...
                            <li class="list-group-item" style="border-bottom:dashed 1px #ccc;border-top:dashed 1px #ccc;height:60px;">
                                <div style="width:100%;height:38px; overflow:hidden;"><a href="<?php echo url('article/them',array('cateid'=>$newlist['id'])); ?>" title="" style="">[<?php echo date("y-m-d",$newlist['time']); ?>]<?php echo $newlist['title']; ?></a></div>
                            </li>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </ul>
                    </div>
