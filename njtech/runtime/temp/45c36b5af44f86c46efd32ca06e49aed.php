<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:86:"/Applications/MAMP/htdocs/njtech/public/../application/index/view/listree/Listree.html";i:1536058342;s:81:"/Applications/MAMP/htdocs/njtech/public/../application/index/view/public/top.html";i:1536049522;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="utf-8">
                ...
                <ul class="nav navbar-nav nav-pills" style="display: inline-block;float: none;">
                    ...
                    <li class="dropdown" style="background-color: #0093dd;color: white;">
                        <a style="background-color: #0093dd;color: white;" id="dLabel" role="button" data-toggle="dropdown" class="btn" data-target="<?php echo url('listmenu/lst'); ?>"
                           href="http://127.0.0.1:8888/njtech/public/index.php/index/artlist/lst/cateid/<?php echo $cate['id']; ?>">
                        ...
                        <ul class="dropdown-menu multi-level" role="menu" aria-labelledby="dropdownMenu">
                            ...
                            <li><a href="http://127.0.0.1:8888/njtech/public/index.php/index/artlist/lst/cateid/<?php echo $v2['id']; ?>"><?php echo $v2['catename'];?></a></li>
...
<!--底部导航栏-->
<div class="myfooter hidden-print" style="margin-top:10px;background-color: #0093dd">
    <div class="row">
        <img src="images/weizhang.png" alt="" style="width: 90px;float: right;" class="img-rounded">
    </div>
</div>
<!--底部导航栏-->
</body>
