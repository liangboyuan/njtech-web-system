...
<nav class="navbar" role="navigation" style="background-color: #265CB4">
    ...
    <div class="container body-content mycontent">
        ...
        <!--<div class="row" style="margin-top: 10px;">
            <div class="col-md-12">
                <div class="container-fluid">
                    <h4><span class="glyphicon glyphicon-list-alt" aria-hidden="true" style="float: left;margin-right: 10px"></span>新闻列表</h4>
                </div>
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body" style="min-height: 450px;">
                                <table class="table">
                                    ...
                                    <tr>
                                        <td><a href="<?php echo url(('article/index3'),array('cateid'=>$article1['id'])); ?>"><?php echo $article1['title']; ?></a></td>
                                        <td width="100px"><a href="<?php echo url(('article/index3'),array('cateid'=>$article1['id'])); ?>"><?php echo date("Y-m-d",$article1['time']); ?></a></td>
                                    </tr>
                                    <?php endforeach; endif; else: echo "" ;endif; ?>
                                </table>
                            </div>
