<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:80:"/Applications/MAMP/htdocs/njtech/public/../application/admin/view/link/edit.html";i:1539917977;s:83:"/Applications/MAMP/htdocs/njtech/public/../application/admin/view/public/title.html";i:1532588368;s:81:"/Applications/MAMP/htdocs/njtech/public/../application/admin/view/public/top.html";i:1532587766;s:82:"/Applications/MAMP/htdocs/njtech/public/../application/admin/view/public/left.html";i:1539911481;}*/ ?>
<!DOCTYPE html>
<html><head>
        <meta charset="utf-8">
    <link rel="apple-touch-icon" sizes="76x76" href="__ADMIN__/images/njtech.jpg">
<link rel="icon" type="image/png" sizes="96x96" href="__ADMIN__/images/njtech.jpg">
                ...
                <div class="page-breadcrumbs">
                    <ul class="breadcrumb">
                        ...
                        <a href="#">系统</a>
                                        ...
                                        <li>
                        <a href="<?php echo url('lst'); ?>">校内外链接管理</a>
                    </li>
                    ...
                    <input type="hidden" name="id" value="<?php echo $links['id']; ?>">
                       <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="cate">
                                    <option value="1" <?php if($links['cate'] == 1): ?> selected="selected"<?php endif; ?>>校内链接</option>
                                    <option value="2" <?php if($links['cate'] == 2): ?> selected="selected"<?php endif; ?>>校外链接</option>
                                </select>
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
