                    ...
                    <form action="" method="post">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="25%"><?php echo mb_substr($art['title'], 0,19,'utf-8'); if(strlen($art['title'])>19){echo '...';}?></td>
                                    <td align="center">
                                        <?php if($art['thumb'] != ''): ?>
