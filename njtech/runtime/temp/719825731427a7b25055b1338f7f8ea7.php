...
<head>
    ...
    <meta property="og:description" content="<?php echo $articles['content']; ?>">
            ...
            <div class="col-md-9">
                <div class="panel" style="margin-top: 10px;min-height: 500px;border: 1px solid #265CB4;">
                    <div class="panel-heading" style="background-color: #265CB4;color: white;">
                        <h3 class="panel-title" align="left">&nbsp&nbsp</h3>
                    </div>
...
<!--分享-->
<!--<div style="width:150px ;height: 30px;border: 1px solid red;margin: 0 auto;">
